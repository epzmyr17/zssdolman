...
sap.ui.define([
	"com/globe/ph/create/dtd/request/dtdCreateRequest/controller/dashboard.controller"
	...
	QUnit.test("I should test the app controller loads", function (assert) {
		...
		assert.ok(sName, "com/globe/ph/create/dtd/request/dtdCreateRequest.controller.dashboard");
	});
